...
// Sample product data (NEW MEN'S COLLECTION)
const products = [
  {
    id: 101,
    ...
    originalPrice: 79.99,
    image:
      "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=300&h=350&fit=crop&crop=center",
    images: [
      "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=600&h=700&fit=crop&crop=center",
    ],
    category: "shirts",
    brand: "uniqlo",
    sizes: ["S", "M", "L", "XL"],
    ...
    discount: true,
    description:
      "Breathable linen shirt for a cool, casual look. Perfect for summer days and evenings out.",
  },
  {
    id: 102,
    ...
    originalPrice: 64.99,
    image:
      "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=300&h=350&fit=crop&crop=center",
    images: [
      "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=600&h=700&fit=crop&crop=center",
    ],
    category: "pants",
    ...
    discount: false,
    description:
      "Trendy cargo joggers with multiple pockets and a tapered fit. Great for streetwear and casual outings.",
  },
  {
    id: 103,
    ...
    originalPrice: 49.99,
    image:
      "https://images.unsplash.com/photo-1469398715555-76331a6c7b29?w=300&h=350&fit=crop&crop=center",
    images: [
      "https://images.unsplash.com/photo-1469398715555-76331a6c7b29?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=600&h=700&fit=crop&crop=center",
    ],
    category: "t-shirts",
    ...
    discount: true,
    description:
      "Classic crewneck sweatshirt made from soft cotton blend. A wardrobe staple for every man.",
  },
  {
    id: 104,
    ...
    originalPrice: 69.99,
    image:
      "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=300&h=350&fit=crop&crop=center",
    images: [
      "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1469398715555-76331a6c7b29?w=600&h=700&fit=crop&crop=center",
    ...
    discount: true,
    description:
      "Modern slim fit chinos with a touch of stretch for comfort. Perfect for work or weekends.",
  },
  {
    id: 105,
    ...
    originalPrice: 99.99,
    image:
      "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=300&h=350&fit=crop&crop=center",
    images: [
      "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=600&h=700&fit=crop&crop=center",
      "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=600&h=700&fit=crop&crop=center",
    ...
    discount: true,
    description:
      "Iconic denim jacket with a regular fit. Durable and stylish for any season.",
  },
  {
    id: 106,
    ...
    discount: true,
    description:
      "Lightweight running shoes with advanced cushioning and support. Designed for performance.",
  },
  {
    id: 107,
    ...
    discount: true,
    description:
      "Elegant wool blend overcoat for a sophisticated winter look. Warm and stylish.",
  },
  {
    id: 108,
    ...
    discount: true,
    description:
      "Sleek leather sneakers with a minimalist design. Versatile for casual and smart outfits.",
  },
];
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Set price input fields to match slider defaults
  ...
  if (priceMinInput && priceMinSlider) {
    priceMinInput.value = priceMinSlider.value = 0;
  }
  if (priceMaxInput && priceMaxSlider) {
    priceMaxInput.value = priceMaxSlider.value = 500;
  }
...
function setupEventListeners() {
  ...
  document.addEventListener("click", (e) => {
    if (window.innerWidth <= 992 && filtersSidebar) {
      if (
...
function initializeFilters() {
  ...
  const categoryCheckboxes = document.querySelectorAll(
    'input[value="shirts"], input[value="t-shirts"], input[value="jeans"], input[value="jackets"], input[value="pants"], input[value="shoes"]'
  );
  ...
  const brandCheckboxes = document.querySelectorAll(
    'input[value="nike"], input[value="adidas"], input[value="puma"], input[value="levis"], input[value="calvin-klein"]'
  );
...
function updateActiveFilters() {
  ...
  activeFilters.categories = Array.from(
    document.querySelectorAll(
      'input[value="shirts"], input[value="t-shirts"], input[value="jeans"], input[value="jackets"], input[value="pants"], input[value="shoes"]:checked'
    )
  ).map((cb) => cb.value);
  ...
  activeFilters.brands = Array.from(
    document.querySelectorAll(
      'input[value="nike"], input[value="adidas"], input[value="puma"], input[value="levis"], input[value="calvin-klein"]:checked'
    )
  ).map((cb) => cb.value);
  ...
  // Price range
  let minInput = parseInt(document.getElementById("price-min-input").value);
  let maxInput = parseInt(document.getElementById("price-max-input").value);
  let minSlider = parseInt(document.getElementById("price-min").value);
  let maxSlider = parseInt(document.getElementById("price-max").value);

  activeFilters.priceRange.min = !isNaN(minInput) ? minInput : minSlider;
  activeFilters.priceRange.max = !isNaN(maxInput) ? maxInput : maxSlider;
}
